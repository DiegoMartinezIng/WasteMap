        ...
        GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Bundle bundleExtra = intent.getBundleExtra(FormPuntoRecoleccionActivity.Data.BUNDLE);
        model = (PuntoRecoleccionModel) bundleExtra.getSerializable(FormPuntoRecoleccionActivity.Data.PUNTO_RECOLECCION_MODEL);
        this.ejecutarDibujarPuntos = bundleExtra.getBoolean(Data.ACCION_DIBUJAR_PUNTOS);
