...
import com.example.wastecontrol.fragmen.CategoriaResiduoFragment;
import com.example.wastecontrol.fragmen.TipoResiduoFragment;
...
//    EditText txtCategoriaResiduo;
    ...
    // @BindView(R.id.fgtCategoriaResiduo)
    CategoriaResiduoFragment fgtCategoriaResiduo;

//    @BindView(R.id.txtTipoResiduo)
//    EditText txtTipoResiduo;

    // @BindView(R.id.fgtTipoResiduo)
    TipoResiduoFragment fgtTipoResiduo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fgtCategoriaResiduo = (CategoriaResiduoFragment) getSupportFragmentManager().findFragmentById(R.id.fgtCategoriaResiduo);
        fgtTipoResiduo = (TipoResiduoFragment) getSupportFragmentManager().findFragmentById(R.id.fgtTipoResiduo);
    ...
    public void onClickAceptar(View view){
        ...
        model.setCategoriaResiduo(fgtCategoriaResiduo.getCategoriaSeleccionada());
        model.setTipoResiduo(fgtTipoResiduo.getTipoResiduoSeleccionado());
